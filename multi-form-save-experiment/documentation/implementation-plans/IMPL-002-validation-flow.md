...
This implementation plan covers the validation system that validates all dirty forms when the save button is clicked. It
uses Zod for schema validation and coordinates validation across multiple child forms using React refs.
...
import {type FormAData, formASchema} from '../schemas/formSchemas';
import {
